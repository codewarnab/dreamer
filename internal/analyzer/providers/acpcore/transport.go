...
func dialStdio(ctx context.Context, providerID string, command []string, env map[string]string, sandboxMode, sandboxNetwork, sandboxSeccomp string, sandboxResources SandboxResourceLimits) (*transport, error) {
	...
	sbCfg := sandbox.Config{
		...
		Mode:         sbMode,
		ProjectWrite: false, // ACP doesn't know project dir at spawn time
		Network:      sandboxNetwork,
		Seccomp:      sandboxSeccomp,
		Resources: sandbox.ResourceLimits{
			MemoryMB:  sandboxResources.MemoryMB,
			Processes: sandboxResources.Processes,
			FDs:       sandboxResources.FDs,
		},
	}
